...
if (!class_exists(__NAMESPACE__ . '\KJG_WC_AC_Hook') && ( in_array( 'woocommerce/woocommerce.php', apply_filters('active_plugins', (array) get_option( 'active_plugins' ) ) ) || array_key_exists ( 'woocommerce/woocommerce.php', (array) get_site_option( 'active_sitewide_plugins' ) ) ) ) :
...
class KJG_WC_AC_Hook {
	...
	public function __construct() {
		$this->basename = $GLOBALS['KJG_WC_AC_Hook_basename'];
	...
	public function add_integration( $integrations ) {
		...
		$integrations[] = __NAMESPACE__ .'\KJG_WC_AC_Hook_Integration';
		return $integrations;
	}
